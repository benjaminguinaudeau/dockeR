...
prune_containers()
# First Container
create_container(image_src = "selenium/standalone-chrome-debug", #Image to be used (model for the container)
                 container_name = "chrome_1") # Name you want to use
```
...
# Second Container
create_container(image_src = "selenium/standalone-firefox", #Image to be used (model for the container)
                 container_name = "firefox") # Name you want to use

# Third Container
create_container(image_src = "selenium/standalone-phantomJS", #Image to be used (model for the container)
...
stop_container("phantomJS", remove = T)
remove_container("firefox") # Works only if the container is already stopped
stop_container("firefox")
remove_container("firefox")
...
```{r}
get_port("chrome_1")
get_port("chrome_1", 4444L)
get_port("chrome_1", c(4444L, 5900L))
...
## Trash
```{r}
stop_container("chrome_1", remove = T)
create_container(image_src = "selenium/standalone-chrome-debug", #Image to be used (model for the container)
                 container_name = "chrome_1", 
                 expose_port = c(80, 8787L)) # Name you want to use
get_port("chrome_1")
